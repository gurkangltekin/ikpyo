                                    ...
                                    try {
                                        ...
                                        if (this.getDepartman().getText().equals("")) {
                                            ...
                                            if (this.getKisiyiGuncelle_yeniKisiEkle().getText().equals("Yeni Personel Ekle")) {
                                                if (this.getDepartman().getText().equals("Pazarlamacı")) {
                                                    ...
                                                    this.getHata().setText("Bu sayfadan sadece Pazarlamacı departmanından eleman ekleyebilirsiniz!");
                                                }
                                            } else {
                                                if (this.getDepartman().getText().equals("Pazarlamacı")) {
                                                    this.personelGuncelle();
                                                } else {
                                                    this.getHata().setText("Bu sayfadan sadece Pazarlamacı departmanından eleman düzeleyebilirsiniz!");
                                                }
                                            }
                                        }
                                    } catch (Exception ex) {
