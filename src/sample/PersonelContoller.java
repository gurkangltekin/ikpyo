...
public class PersonelContoller implements Initializable {
                                    ...
                                    try {
                                        ...
                                        if (this.getDepartman().getText().equals("")) {
                                            ...
                                            if (this.getKisiyiGuncelle_yeniKisiEkle().getText().equals("Yeni Personel Ekle")) {
                                                ...
                                                } else if (this.getDepartman().getText().equals("IT Elemanı")) {
                                                ...
                                                } else if (this.getDepartman().getText().equals("Mühendis")) {
    ...
    */
    ...
    public void setIseGirisSaatleri(ListView iseGirisSaatleri) {
    ...
    public void setIstenCikisSaatleri(ListView istenCikisSaatleri) {
