...
public class ITElemaniController extends PersonelContoller {
                                    ...
                                    try {
                                        ...
                                        if (this.getDepartman().getText().equals("")) {
                                            ...
                                            if (this.getKisiyiGuncelle_yeniKisiEkle().getText().equals("Yeni Personel Ekle")) {
                                                if (this.getDepartman().getText().equals("IT Elemanı")) {
                                                    ...
                                                    this.getHata().setText("Bu sayfadan sadece IT Elemanı departmanından eleman ekleyebilirsiniz!");
                                                }
                                            } else {
                                                if (this.getDepartman().getText().equals("IT Elemanı")) {
                                                    this.personelGuncelle();
                                                } else {
                                                    this.getHata().setText("Bu sayfadan sadece IT Elemanı departmanından eleman düzeleyebilirsiniz!");
                                                }
                                            }
    ...
    public sample.ITElemani getSelectedITElemani() {
        return selectedITElemani;
    }

    public void setSelectedITElemani(sample.ITElemani selectedITElemani) {
    ...
    public TableColumn<sample.ITElemani, Long> getTableTC() {
        return tableTC;
    }

    public void setTableTC(TableColumn<sample.ITElemani, Long> tableTC) {
        this.tableTC = tableTC;
    }

    public TableColumn<sample.ITElemani, String> getTableAdi() {
        return tableAdi;
    }

    public void setTableAdi(TableColumn<sample.ITElemani, String> tableAdi) {
        this.tableAdi = tableAdi;
    }

    public TableColumn<sample.ITElemani, String> getTableSoyadi() {
        return tableSoyadi;
    }

    public void setTableSoyadi(TableColumn<sample.ITElemani, String> tableSoyadi) {
        this.tableSoyadi = tableSoyadi;
    }

    public TableColumn<sample.ITElemani, String> getTableDepartmani() {
        return tableDepartmani;
    }

    public void setTableDepartmani(TableColumn<sample.ITElemani, String> tableDepartmani) {
        this.tableDepartmani = tableDepartmani;
    }

    public TableColumn<sample.ITElemani, Date> getTableIsegiris() {
        return tableIsegiris;
    }

    public void setTableIsegiris(TableColumn<sample.ITElemani, Date> tableIsegiris) {
        this.tableIsegiris = tableIsegiris;
    }

    public ObservableList<sample.ITElemani> getList() {
        return list;
    }

    public void setList(ObservableList<sample.ITElemani> list) {
        this.list = list;
    }
}
