...
public class MuhendisController extends PersonelContoller {
                                    ...
                                    try {
                                        ...
                                        if (this.getDepartman().getText().equals("")) {
                                            ...
                                            if (this.getKisiyiGuncelle_yeniKisiEkle().getText().equals("Yeni Personel Ekle")) {
                                                if (this.getDepartman().getText().equals("Mühendis")) {
                                                    ...
                                                    this.getHata().setText("Bu sayfadan sadece Mühendis departmanından eleman ekleyebilirsiniz!");
                                                }
                                            } else {
                                                if (this.getDepartman().getText().equals("Mühendis")) {
                                                    this.personelGuncelle();
                                                } else {
                                                    this.getHata().setText("Bu sayfadan sadece Mühendis departmanından eleman düzeleyebilirsiniz!");
                                                }
                                            }
                                        }
                                    } catch (Exception ex) {
    ...
    public void setTableTC(TableColumn<Muhendis, Long> tableTC) {
    ...
    public void setTableAdi(TableColumn<Muhendis, String> tableAdi) {
    ...
    public void setTableSoyadi(TableColumn<Muhendis, String> tableSoyadi) {
    ...
    public void setTableDepartmani(TableColumn<Muhendis, String> tableDepartmani) {
    ...
    public void setTableIsegiris(TableColumn<Muhendis, Date> tableIsegiris) {
    ...
    public void setList(ObservableList<Muhendis> list) {
        this.list = list;
    }
